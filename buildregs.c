...
struct registers struct_CACHE_MODE_0[]={
	{" CM0_MASK_SHIFT ",CM0_MASK_SHIFT },
	{" CM0_IZ_OPT_DISABLE ",CM0_IZ_OPT_DISABLE },
	{" CM0_ZR_OPT_DISABLE ",CM0_ZR_OPT_DISABLE },
	{" CM0_STC_EVICT_DISABLE_LRA_SNB ",CM0_STC_EVICT_DISABLE_LRA_SNB },
	{" CM0_DEPTH_EVICT_DISABLE ",CM0_DEPTH_EVICT_DISABLE },
	{" CM0_COLOR_EVICT_DISABLE ",CM0_COLOR_EVICT_DISABLE },
	{" CM0_DEPTH_WRITE_DISABLE ",CM0_DEPTH_WRITE_DISABLE },
	{" CM0_RC_OP_FLUSH_DISABLE ",CM0_RC_OP_FLUSH_DISABLE },
	{NULL, 0},
};
...
struct registers struct_GEN6_BSD_SLEEP_PSMI_CONTROL[]={
	...
	{" GEN6_BSD_SLEEP_PSMI_CONTROL_IDLE_INDICATOR ",GEN6_BSD_SLEEP_PSMI_CONTROL_IDLE_INDICATOR },
	{NULL, 0},
};
...
struct registers struct_PORT_HOTPLUG_STAT[]={
	...
	{" SDVOC_HOTPLUG_INT_STATUS ",SDVOC_HOTPLUG_INT_STATUS },
	{" SDVOB_HOTPLUG_INT_STATUS ",SDVOB_HOTPLUG_INT_STATUS },
	{NULL, 0},
};
...
struct registers struct_LVDS[]={
	...
	{" LVDS_PIPEB_SELECT ",LVDS_PIPEB_SELECT },
	{" LVDS_PIPE_MASK ",LVDS_PIPE_MASK },
	{" LVDS_ENABLE_DITHER ",LVDS_ENABLE_DITHER },
	{" LVDS_VSYNC_POLARITY ",LVDS_VSYNC_POLARITY },
	{" LVDS_HSYNC_POLARITY ",LVDS_HSYNC_POLARITY },
	{" LVDS_BORDER_ENABLE ",LVDS_BORDER_ENABLE },
	{" LVDS_A0A2_CLKA_POWER_MASK ",LVDS_A0A2_CLKA_POWER_MASK },
	{" LVDS_A0A2_CLKA_POWER_DOWN ",LVDS_A0A2_CLKA_POWER_DOWN },
	{" LVDS_A0A2_CLKA_POWER_UP ",LVDS_A0A2_CLKA_POWER_UP },
	{" LVDS_A3_POWER_MASK ",LVDS_A3_POWER_MASK },
	{" LVDS_A3_POWER_DOWN ",LVDS_A3_POWER_DOWN },
	{" LVDS_A3_POWER_UP ",LVDS_A3_POWER_UP },
	{" LVDS_CLKB_POWER_MASK ",LVDS_CLKB_POWER_MASK },
	{" LVDS_CLKB_POWER_DOWN ",LVDS_CLKB_POWER_DOWN },
	{" LVDS_CLKB_POWER_UP ",LVDS_CLKB_POWER_UP },
	{" LVDS_B0B3_POWER_MASK ",LVDS_B0B3_POWER_MASK },
	{" LVDS_B0B3_POWER_DOWN ",LVDS_B0B3_POWER_DOWN },
	{" LVDS_B0B3_POWER_UP ",LVDS_B0B3_POWER_UP },
	{NULL, 0},
};
...
struct registers struct_DP_D[]={
	...
	{" DP_PIPEB_SELECT ",DP_PIPEB_SELECT },
	{" DP_PIPE_MASK ",DP_PIPE_MASK },
	{" DP_LINK_TRAIN_PAT_1 ",DP_LINK_TRAIN_PAT_1 },
	{" DP_LINK_TRAIN_PAT_2 ",DP_LINK_TRAIN_PAT_2 },
	{" DP_LINK_TRAIN_PAT_IDLE ",DP_LINK_TRAIN_PAT_IDLE },
	{" DP_LINK_TRAIN_OFF ",DP_LINK_TRAIN_OFF },
	{" DP_LINK_TRAIN_MASK ",DP_LINK_TRAIN_MASK },
	{" DP_LINK_TRAIN_SHIFT ",DP_LINK_TRAIN_SHIFT },
	{" DP_LINK_TRAIN_PAT_1_CPT ",DP_LINK_TRAIN_PAT_1_CPT },
	{" DP_LINK_TRAIN_PAT_2_CPT ",DP_LINK_TRAIN_PAT_2_CPT },
	{" DP_LINK_TRAIN_PAT_IDLE_CPT ",DP_LINK_TRAIN_PAT_IDLE_CPT },
	{" DP_LINK_TRAIN_OFF_CPT ",DP_LINK_TRAIN_OFF_CPT },
	{" DP_LINK_TRAIN_MASK_CPT ",DP_LINK_TRAIN_MASK_CPT },
	{" DP_LINK_TRAIN_SHIFT_CPT ",DP_LINK_TRAIN_SHIFT_CPT },
	{" DP_VOLTAGE_0_4 ",DP_VOLTAGE_0_4 },
	{" DP_VOLTAGE_0_6 ",DP_VOLTAGE_0_6 },
	{" DP_VOLTAGE_0_8 ",DP_VOLTAGE_0_8 },
	{" DP_VOLTAGE_1_2 ",DP_VOLTAGE_1_2 },
	{" DP_VOLTAGE_MASK ",DP_VOLTAGE_MASK },
	{" DP_VOLTAGE_SHIFT ",DP_VOLTAGE_SHIFT },
	{" DP_PRE_EMPHASIS_0 ",DP_PRE_EMPHASIS_0 },
	{" DP_PRE_EMPHASIS_3_5 ",DP_PRE_EMPHASIS_3_5 },
	{" DP_PRE_EMPHASIS_6 ",DP_PRE_EMPHASIS_6 },
	{" DP_PRE_EMPHASIS_9_5 ",DP_PRE_EMPHASIS_9_5 },
	{" DP_PRE_EMPHASIS_MASK ",DP_PRE_EMPHASIS_MASK },
	{" DP_PRE_EMPHASIS_SHIFT ",DP_PRE_EMPHASIS_SHIFT },
	{" DP_PORT_WIDTH_1 ",DP_PORT_WIDTH_1 },
	{" DP_PORT_WIDTH_2 ",DP_PORT_WIDTH_2 },
	{" DP_PORT_WIDTH_4 ",DP_PORT_WIDTH_4 },
	{" DP_PORT_WIDTH_MASK ",DP_PORT_WIDTH_MASK },
	{" DP_ENHANCED_FRAMING ",DP_ENHANCED_FRAMING },
	{" DP_PLL_FREQ_270MHZ ",DP_PLL_FREQ_270MHZ },
	{" DP_PLL_FREQ_160MHZ ",DP_PLL_FREQ_160MHZ },
	{" DP_PLL_FREQ_MASK ",DP_PLL_FREQ_MASK },
...
struct registers struct__PIPEACONF[]={
	...
	{" PIPECONF_FRAME_START_DELAY_MASK ",PIPECONF_FRAME_START_DELAY_MASK },
	...
	{" PIPECONF_BPP_8 ",PIPECONF_BPP_8 },
	{" PIPECONF_BPP_10 ",PIPECONF_BPP_10 },
	{" PIPECONF_BPP_6 ",PIPECONF_BPP_6 },
	{" PIPECONF_BPP_12 ",PIPECONF_BPP_12 },
	{" PIPECONF_DITHER_EN ",PIPECONF_DITHER_EN },
	{" PIPECONF_DITHER_TYPE_SP ",PIPECONF_DITHER_TYPE_SP },
	{" PIPECONF_DITHER_TYPE_ST1 ",PIPECONF_DITHER_TYPE_ST1 },
	{" PIPECONF_DITHER_TYPE_ST2 ",PIPECONF_DITHER_TYPE_ST2 },
	{" PIPECONF_DITHER_TYPE_TEMP ",PIPECONF_DITHER_TYPE_TEMP },
	{NULL, 0},
};
...
struct registers struct_MLTR_ILK[]={
	...
	{" ILK_LATENCY(shift) ",ILK_LATENCY(shift) },
	{" ILK_READ_WM1_LATENCY() ",ILK_READ_WM1_LATENCY() },
	{" ILK_READ_WM2_LATENCY() ",ILK_READ_WM2_LATENCY() },
	...
	{" SNB_LATENCY(shift) ",SNB_LATENCY(shift) },
	{" SNB_READ_WM0_LATENCY() ",SNB_READ_WM0_LATENCY() },
	{" SNB_READ_WM1_LATENCY() ",SNB_READ_WM1_LATENCY() },
	{" SNB_READ_WM2_LATENCY() ",SNB_READ_WM2_LATENCY() },
	{" SNB_READ_WM3_LATENCY() ",SNB_READ_WM3_LATENCY() },
	{NULL, 0},
};
...
struct registers struct__DSPACNTR[]={
	...
	{" DISPLAY_PLANE_DISABLE ",DISPLAY_PLANE_DISABLE },
	{" DISPPLANE_GAMMA_ENABLE ",DISPPLANE_GAMMA_ENABLE },
	{" DISPPLANE_GAMMA_DISABLE ",DISPPLANE_GAMMA_DISABLE },
	{" DISPPLANE_STEREO_ENABLE ",DISPPLANE_STEREO_ENABLE },
	{" DISPPLANE_STEREO_DISABLE ",DISPPLANE_STEREO_DISABLE },
	{" DISPPLANE_SEL_PIPE_SHIFT ",DISPPLANE_SEL_PIPE_SHIFT },
	{" DISPPLANE_SEL_PIPE_MASK ",DISPPLANE_SEL_PIPE_MASK },
	{" DISPPLANE_SEL_PIPE_A ",DISPPLANE_SEL_PIPE_A },
	{" DISPPLANE_SEL_PIPE_B ",DISPPLANE_SEL_PIPE_B },
	{" DISPPLANE_SRC_KEY_ENABLE ",DISPPLANE_SRC_KEY_ENABLE },
	{" DISPPLANE_SRC_KEY_DISABLE ",DISPPLANE_SRC_KEY_DISABLE },
	{" DISPPLANE_LINE_DOUBLE ",DISPPLANE_LINE_DOUBLE },
	{" DISPPLANE_NO_LINE_DOUBLE ",DISPPLANE_NO_LINE_DOUBLE },
...
struct registers struct__TRANSB_CHICKEN2[]={
	{" TRANS_AUTOTRAIN_GEN_STALL_DIS ",TRANS_AUTOTRAIN_GEN_STALL_DIS },
	{NULL, 0},
};
...
struct registers struct_PCH_ADPA[]={
	{" ADPA_TRANS_SELECT_MASK ",ADPA_TRANS_SELECT_MASK },
	{" ADPA_TRANS_A_SELECT ",ADPA_TRANS_A_SELECT },
	{" ADPA_TRANS_B_SELECT ",ADPA_TRANS_B_SELECT },
...
struct registers struct_PCH_LVDS[]={
	{" LVDS_DETECTED ",LVDS_DETECTED },
	{NULL, 0},
};

struct registers struct_BLC_PWM_CPU_CTL2[]={
	{" PWM_ENABLE ",PWM_ENABLE },
	{" PWM_PIPE_A ",PWM_PIPE_A },
	{" PWM_PIPE_B ",PWM_PIPE_B },
	{NULL, 0},
};
...
struct registers struct_BLC_PWM_PCH_CTL1[]={
	{" PWM_PCH_ENABLE ",PWM_PCH_ENABLE },
	{" PWM_POLARITY_ACTIVE_LOW ",PWM_POLARITY_ACTIVE_LOW },
	{" PWM_POLARITY_ACTIVE_HIGH ",PWM_POLARITY_ACTIVE_HIGH },
	{" PWM_POLARITY_ACTIVE_LOW2 ",PWM_POLARITY_ACTIVE_LOW2 },
	{" PWM_POLARITY_ACTIVE_HIGH2 ",PWM_POLARITY_ACTIVE_HIGH2 },
	{NULL, 0},
};
...
struct registers struct_PCH_PP_ON_DELAYS[]={
	...
	{" PANEL_PORT_SELECT_LVDS ",PANEL_PORT_SELECT_LVDS },
	{" PANEL_PORT_SELECT_DPA ",PANEL_PORT_SELECT_DPA },
	{" EDP_PANEL ",EDP_PANEL },
	{" PANEL_PORT_SELECT_DPC ",PANEL_PORT_SELECT_DPC },
	{" PANEL_PORT_SELECT_DPD ",PANEL_PORT_SELECT_DPD },
	{" PANEL_POWER_UP_DELAY_SHIFT ",PANEL_POWER_UP_DELAY_SHIFT },
	{" PANEL_LIGHT_ON_DELAY_SHIFT ",PANEL_LIGHT_ON_DELAY_SHIFT },
	{NULL, 0},
};

struct registers struct_PCH_PP_OFF_DELAYS[]={
	{" PANEL_POWER_DOWN_DELAY_SHIFT ",PANEL_POWER_DOWN_DELAY_SHIFT },
	{" PANEL_LIGHT_OFF_DELAY_SHIFT ",PANEL_LIGHT_OFF_DELAY_SHIFT },
	{NULL, 0},
};
...
struct registers *reglist[] = {
	...
	[GEN6_BSD_SLEEP_PSMI_CONTROL] = (struct registers *)struct_GEN6_BSD_SLEEP_PSMI_CONTROL,
	...
	[PRB1_TAIL] = (struct registers *)struct_PRB1_TAIL,
	[PRB1_HEAD] = (struct registers *)struct_PRB1_HEAD,
	[PRB1_START] = (struct registers *)struct_PRB1_START,
	[PRB1_CTL] = (struct registers *)struct_PRB1_CTL,
	...
	[DP_A] = (struct registers *)struct_DP_A,
	[DSPFW3] = (struct registers *)struct_DSPFW3,
	[DP_B] = (struct registers *)struct_DP_B,
	[WM0_PIPEA_ILK] = (struct registers *)struct_WM0_PIPEA_ILK,
	[DP_C] = (struct registers *)struct_DP_C,
	...
	[PCH_LVDS] = (struct registers *)struct_PCH_LVDS,
	...
	[PCH_DSPCLK_GATE_D] = (struct registers *)struct_PCH_DSPCLK_GATE_D,
	...
	[DVOA] = (struct registers *)struct_DVOA,
	...
	[ILK_DSPCLK_GATE] = (struct registers *)struct_ILK_DSPCLK_GATE,
	...
	[CACHE_MODE_0] = (struct registers *)struct_CACHE_MODE_0,
