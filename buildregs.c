...
struct registers struct_PCH_PP_ON_DELAYS[]={
	...
	{" PANEL_POWER_UP_DELAY ", PANEL_POWER_UP_DELAY_MASK, 0xffffffff, 1, PANEL_POWER_UP_DELAY_SHIFT },
	{" PANEL_LIGHT_ON_DELAY ",PANEL_LIGHT_ON_DELAY_MASK, 0xffffffff, 1, PANEL_LIGHT_ON_DELAY_SHIFT },
	{NULL, 0},
};

struct registers struct_PCH_PP_OFF_DELAYS[]={
	{" PANEL_POWER_DOWN_DELAY ",PANEL_POWER_DOWN_DELAY_MASK, 0xffffffff, 1, PANEL_POWER_DOWN_DELAY_SHIFT },
	{" PANEL_LIGHT_OFF_DELAY ",PANEL_LIGHT_OFF_DELAY_MASK, 0xffffffff, 1, PANEL_LIGHT_OFF_DELAY_SHIFT },
	{NULL, 0},
};
