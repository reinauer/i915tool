{M, 1, "[drm:i915_driver_load], Warning:somebody tried to call pci_set_master", 0x0, 0x0, 0},
...
{R, 1, "", PCH_PP_ON_DELAYS, ( PANEL_PORT_SELECT_MASK &0x40000000)| PANEL_PORT_SELECT_LVDS | PANEL_PORT_SELECT_DPA | EDP_PANEL | PANEL_PORT_SELECT_DPC |( PANEL_PORT_SELECT_DPD &0x0)| PANEL_POWER_UP_DELAY_SHIFT | PANEL_LIGHT_ON_DELAY_SHIFT |0x07d007c0, 0},
{R, 1, "", PCH_PP_OFF_DELAYS,  PANEL_POWER_DOWN_DELAY_SHIFT | PANEL_LIGHT_OFF_DELAY_SHIFT |0x01f407c0, 0},
{R, 1, "", PCH_PP_DIVISOR,  PP_REFERENCE_DIVIDER_SHIFT | PANEL_POWER_CYCLE_DELAY_SHIFT |0x00186906, 0},
{M, 1, "[drm:intel_dp_init], cur t1_t3 2000 t8 2000 t9 2000 t10 500 t11_t12 6000", 0x0, 0x0, 0},
...
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0x00000000, 0},
...
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0x00000000, 0},
{W, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
...
{M, 1, "[drm:ironlake_edp_panel_vdd_on], Turn eDP VDD on", 0x0, 0x0, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
{M, 1, "[drm:ironlake_edp_panel_vdd_on], eDP VDD already on", 0x0, 0x0, 0},
{R, 1, "", PCH_PP_STATUS, 0x00000000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
{R, 1, "", PCH_PP_STATUS, 0x00000000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
...
{M, 1, "[drm:ironlake_init_pch_refclk], has_panel 1 has_lvds 0 has_pch_edp 0 has_cpu_edp 1 has_ck505 0", 0x0, 0x0, 0},
{R, 1, "", PCH_DREF_CONTROL,  DREF_CPU_SOURCE_OUTPUT_DISABLE | DREF_CPU_SOURCE_OUTPUT_DOWNSPREAD |( DREF_CPU_SOURCE_OUTPUT_NONSPREAD &0x0)|( DREF_CPU_SOURCE_OUTPUT_MASK &0x0)| DREF_SSC_SOURCE_DISABLE | DREF_SSC_SOURCE_ENABLE |( DREF_SSC_SOURCE_MASK &0x0)| DREF_NONSPREAD_SOURCE_DISABLE | DREF_NONSPREAD_CK505_ENABLE | DREF_NONSPREAD_SOURCE_ENABLE |( DREF_NONSPREAD_SOURCE_MASK &0x0)| DREF_SUPERSPREAD_SOURCE_DISABLE | DREF_SUPERSPREAD_SOURCE_ENABLE |( DREF_SUPERSPREAD_SOURCE_MASK &0x0)| DREF_SSC4_DOWNSPREAD | DREF_SSC4_CENTERSPREAD | DREF_SSC1_DISABLE | DREF_SSC1_ENABLE | DREF_SSC4_DISABLE | DREF_SSC4_ENABLE |0x00000000, 0},
{M, 1, "[drm:ironlake_init_pch_refclk], Using SSC on panel", 0x0, 0x0, 0},
{W, 1, "", PCH_DREF_CONTROL,  DREF_CPU_SOURCE_OUTPUT_DISABLE | DREF_CPU_SOURCE_OUTPUT_DOWNSPREAD |( DREF_CPU_SOURCE_OUTPUT_NONSPREAD &0x0)|( DREF_CPU_SOURCE_OUTPUT_MASK &0x0)| DREF_SSC_SOURCE_DISABLE | DREF_SSC_SOURCE_ENABLE |( DREF_SSC_SOURCE_MASK &0x0)| DREF_NONSPREAD_SOURCE_DISABLE | DREF_NONSPREAD_CK505_ENABLE | DREF_NONSPREAD_SOURCE_ENABLE |( DREF_NONSPREAD_SOURCE_MASK &0x0)| DREF_SUPERSPREAD_SOURCE_DISABLE | DREF_SUPERSPREAD_SOURCE_ENABLE |( DREF_SUPERSPREAD_SOURCE_MASK &0x0)| DREF_SSC4_DOWNSPREAD | DREF_SSC4_CENTERSPREAD | DREF_SSC1_DISABLE | DREF_SSC1_ENABLE | DREF_SSC4_DISABLE | DREF_SSC4_ENABLE |0x00000000, 0},
{R, 1, "", PCH_DREF_CONTROL,  DREF_CPU_SOURCE_OUTPUT_DISABLE | DREF_CPU_SOURCE_OUTPUT_DOWNSPREAD |( DREF_CPU_SOURCE_OUTPUT_NONSPREAD &0x0)|( DREF_CPU_SOURCE_OUTPUT_MASK &0x0)| DREF_SSC_SOURCE_DISABLE | DREF_SSC_SOURCE_ENABLE |( DREF_SSC_SOURCE_MASK &0x0)| DREF_NONSPREAD_SOURCE_DISABLE | DREF_NONSPREAD_CK505_ENABLE | DREF_NONSPREAD_SOURCE_ENABLE |( DREF_NONSPREAD_SOURCE_MASK &0x0)| DREF_SUPERSPREAD_SOURCE_DISABLE | DREF_SUPERSPREAD_SOURCE_ENABLE |( DREF_SUPERSPREAD_SOURCE_MASK &0x0)| DREF_SSC4_DOWNSPREAD | DREF_SSC4_CENTERSPREAD | DREF_SSC1_DISABLE | DREF_SSC1_ENABLE | DREF_SSC4_DISABLE | DREF_SSC4_ENABLE |0x00000000, 200},
...
{W, 1, "", SOUTH_DSPCLK_GATE_D,  PCH_DPLSUNIT_CLOCK_GATE_DISABLE |0x00000000, 0},
{R, 1, "", SOUTH_CHICKEN2,  DPLS_EDP_PPS_FIX_DIS |0x00000000, 0},
{W, 1, "", SOUTH_CHICKEN2,  DPLS_EDP_PPS_FIX_DIS |0x00000000, 0},
{W, 1, "", _TRANSA_CHICKEN2, 0x80000000, 0},
{W, 1, "", _TRANSB_CHICKEN2,  TRANS_AUTOTRAIN_GEN_STALL_DIS |0x00000000, 0},
...
{M, 1, "[drm:drm_helper_probe_single_connector_modes], [CONNECTOR:8:DP-1]", 0x0, 0x0, 0},
{M, 1, "[drm:drm_setup_crtcs], ", 0x0, 0x0, 0},
{M, 1, "[drm:drm_enable_connectors], connector 6 enabled? yes", 0x0, 0x0, 0},
{M, 1, "[drm:drm_enable_connectors], connector 8 enabled? no", 0x0, 0x0, 0},
...
{M, 1, "[drm:intelfb_create], allocated 2560x1700 fb:0x8348e589, bo 0x405d88", 0x0, 0x0, 0},
{M, 1, "[drm:drm_fb_helper_single_fb_probe], fb0:inteldrmfb frame buffer device", 0x0, 0x0, 0},
...
{W, 1, "", DPA_AUX_CH_CTL, 0x521500c8, 0},
{R, 1, "", DPA_AUX_CH_DATA1, 0x00000000, 0},
{M, 1, "[drm:i2c_algo_dp_aux_xfer], dp_aux_xfer return 2", 0x0, 0x0, 0},
{R, 1, "", PCH_PP_STATUS, 0x00000000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
{R, 1, "", PCH_PP_STATUS, 0x00000000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
...
{W, 1, "", PCH_DPD_AUX_CH_CTL, 0x5345003f, 0},
{M, 1, "[drm:intel_dp_aux_ch], dp_aux_ch timeout status 0x5145003f", 0x0, 0x0, 0},
{M, 1, "[drm:intel_dp_detect], DPCD:0000000000000000", 0x0, 0x0, 0},
{M, 1, "[drm:drm_helper_probe_single_connector_modes], [CONNECTOR:8:DP-1] disconnected", 0x0, 0x0, 0},
{M, 1, "[drm:drm_setup_crtcs], ", 0x0, 0x0, 0},
{M, 1, "[drm:drm_enable_connectors], connector 6 enabled? yes", 0x0, 0x0, 0},
{M, 1, "[drm:drm_enable_connectors], connector 8 enabled? no", 0x0, 0x0, 0},
{M, 1, "[drm:drm_setup_crtcs], picking CRTCs for 8192x8192 config", 0x0, 0x0, 0},
...
{M, 1, "[drm:intel_get_load_detect_pipe], creating tmp fb for load-detection", 0x0, 0x0, 0},
{M, 1, "[drm:intel_dp_mode_fixup], Display port link bw 0a lane count 4 clock 270000", 0x0, 0x0, 0},
...
{R, 1, "", SOUTH_CHICKEN1, ( FDIA_PHASE_SYNC_SHIFT_OVR &0x0)|( FDIA_PHASE_SYNC_SHIFT_EN &0x0)|0x00000000, 0},
{W, 2, "", SOUTH_CHICKEN1, ( FDIA_PHASE_SYNC_SHIFT_OVR &0x0)|( FDIA_PHASE_SYNC_SHIFT_EN &0x0)|0x00000000, 0},
{R, 1, "", SOUTH_CHICKEN1, ( FDIA_PHASE_SYNC_SHIFT_OVR &0x0)|( FDIA_PHASE_SYNC_SHIFT_EN &0x0)|0x00000000, 0},
{R, 1, "", _FDI_TXA_CTL, 0x00040000, 0},
{W, 1, "", _FDI_TXA_CTL, 0x00040000, 0},
...
{R, 2, "", PCH_PP_STATUS, 0x00000000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_OFF | PANEL_POWER_ON |0xabcd0000, 0},
{W, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_ON |0xabcd0000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_ON |0xabcd0000, 0},
...
{M, 1, "[drm:ironlake_edp_panel_vdd_off], Turn eDP VDD off 1", 0x0, 0x0, 0},
{R, 2, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_ON |0xabcd0000, 0},
{W, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_ON |0xabcd0000, 0},
{R, 1, "", PCH_PP_CONTROL,  EDP_FORCE_VDD | EDP_BLC_ENABLE | PANEL_POWER_RESET | PANEL_POWER_ON |0xabcd0000, 0},
