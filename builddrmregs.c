...
struct registers struct_DP_PSR_CAPS[]={
	...
	{" DP_PSR_SETUP_TIME_SHIFT ",DP_PSR_SETUP_TIME_SHIFT ,  0xffffffff },
	{NULL, 0},
};
...
struct registers struct_DP_TRAINING_LANE3_SET[]={
	{" DP_TRAIN_VOLTAGE_SWING_SHIFT ",DP_TRAIN_VOLTAGE_SWING_SHIFT ,  0xffffffff },
	{" DP_TRAIN_MAX_SWING_REACHED ",DP_TRAIN_MAX_SWING_REACHED ,  0xffffffff },
	{" DP_TRAIN_VOLTAGE_SWING_400 ",DP_TRAIN_VOLTAGE_SWING_400 ,  0xffffffff },
	{" DP_TRAIN_VOLTAGE_SWING_600 ",DP_TRAIN_VOLTAGE_SWING_600 ,  0xffffffff },
	{" DP_TRAIN_VOLTAGE_SWING_800 ",DP_TRAIN_VOLTAGE_SWING_800 ,  0xffffffff },
	{" DP_TRAIN_VOLTAGE_SWING_1200 ",DP_TRAIN_VOLTAGE_SWING_1200 ,  0xffffffff },
	{" DP_TRAIN_PRE_EMPHASIS_0 ",DP_TRAIN_PRE_EMPHASIS_0 ,  0xffffffff },
	{" DP_TRAIN_PRE_EMPHASIS_3_5 ",DP_TRAIN_PRE_EMPHASIS_3_5 ,  0xffffffff },
	{" DP_TRAIN_PRE_EMPHASIS_6 ",DP_TRAIN_PRE_EMPHASIS_6 ,  0xffffffff },
	{" DP_TRAIN_PRE_EMPHASIS_9_5 ",DP_TRAIN_PRE_EMPHASIS_9_5 ,  0xffffffff },
	{" DP_TRAIN_PRE_EMPHASIS_SHIFT ",DP_TRAIN_PRE_EMPHASIS_SHIFT ,  0xffffffff },
	{" DP_TRAIN_MAX_PRE_EMPHASIS_REACHED ",DP_TRAIN_MAX_PRE_EMPHASIS_REACHED ,  0xffffffff },
	{NULL, 0},
};
...
struct registers struct_DP_ADJUST_REQUEST_LANE2_3[]={
	{" DP_ADJUST_VOLTAGE_SWING_LANE0_SHIFT ",DP_ADJUST_VOLTAGE_SWING_LANE0_SHIFT ,  0xffffffff },
	{" DP_ADJUST_PRE_EMPHASIS_LANE0_SHIFT ",DP_ADJUST_PRE_EMPHASIS_LANE0_SHIFT ,  0xffffffff },
	{" DP_ADJUST_VOLTAGE_SWING_LANE1_SHIFT ",DP_ADJUST_VOLTAGE_SWING_LANE1_SHIFT ,  0xffffffff },
	{" DP_ADJUST_PRE_EMPHASIS_LANE1_SHIFT ",DP_ADJUST_PRE_EMPHASIS_LANE1_SHIFT ,  0xffffffff },
	{NULL, 0},
};
...
struct registers *drmreglist[] = {
	...
	[DP_TRAINING_LANE0_SET] = (struct registers *)struct_DP_TRAINING_LANE0_SET,
	...
	[DP_TRAINING_LANE1_SET] = (struct registers *)struct_DP_TRAINING_LANE1_SET,
	...
	[DP_TRAINING_LANE2_SET] = (struct registers *)struct_DP_TRAINING_LANE2_SET,
